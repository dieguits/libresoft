...
echo '<tr id="tr'.$articulo->idarticulo.'">'; ?>
	<td style="text-align: right; padding-right: 5px;">
        ...
        <input type="hidden" id="codigo'.$articulo->idarticulo.'" value="'.$articulo->codigoarticulo.'" />
	...
	<td style="text-align: center;">
		...
		<?= '<a id="btnEditar'.$articulo->idarticulo.'" href="" class="btn btn-info">'; ?>
