$(document).ready(function () {
    ...
    $("#frmImprimeVenta").submit(function (e) {
        e.preventDefault();
    ...
    var tabla = $('#dtreporte').DataTable({
        ...
        //"paging": true,
        "ajax": {
            "url": "../reportes/venta/buscarVentasFecha",
            "data": function (d) {
                return $.extend({}, d, {
                    'fechaini': $("#fini").val(),
                    'fechafin': $("#fin").val()
        ...
        "columns": [            
            ...
            {"data": "nombrearticulo", "name": "nombrearticulo"},
            {"data": "cantidadventa", "name": "cantidadventa"},
            {"data": "valoruni", "name": "valoruni"},
